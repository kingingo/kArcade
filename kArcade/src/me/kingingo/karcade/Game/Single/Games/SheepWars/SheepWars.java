...
public class SheepWars extends TeamGame{
	...
	public SheepWars(kArcadeManager manager,SheepWarsType typ){
		...
		kitshop=new SingleKitShop(getManager().getInstance(),getGems(), getCoins(), getManager().getPermManager(), "Kit-Shop", InventorySize._27, new Kit[]{
			...
			new Kit( "§eItemStealer",new String[]{"Der ItemStealer hat nach seinem"," Tod 10 sekunden um seine","Sachen aufzuheben solange","kann er sie nur aufheben."}, new ItemStack(Material.SHEARS),kPermission.SHEEPWARS_KIT_ITEMSTEALER,KitType.KAUFEN,2000,500,new Perk[]{
