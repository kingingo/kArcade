...
public class SkyWars extends TeamGame {
	...
	public SkyWars(ArcadeManager manager, SkyWarsType skyWarsType) {
		super(manager);
		...
		setMaxPlayers(skyWarsType.getMax());
		setMinPlayers(skyWarsType.getMin());
		setDamage(false);
		setDamagePvP(false);
		setDamageSelf(false);
		setBlockBreak(true);
		...
		if (getSkyWarsType().isLuckywars())
			getVoteHandler().add(new SkyWarsTypeVote(this, new LuckyItem[] { new LuckyCow(45), new LuckyCreeper(35), new LuckyWolf(40), new LuckyHeart(35), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_SWORD), "§6Lucky Sword"), new String[] { Enchantment.FIRE_ASPECT.getName() + ":1", Enchantment.DAMAGE_ALL.getName() + ":2" }), 16), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_SWORD), "§6Lucky Sword"), new String[] { Enchantment.DAMAGE_ALL.getName() + ":3" }), 12), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_SWORD), "§6Lucky Sword"), new String[] { Enchantment.KNOCKBACK.getName() + ":2", Enchantment.DAMAGE_ALL.getName() + ":2" }), 10), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_SWORD), "§6Lucky Sword"), new String[] { Enchantment.KNOCKBACK.getName() + ":1", Enchantment.DAMAGE_ALL.getName() + ":3" }), 10), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_SWORD), "§6Lucky Sword"), new String[] { Enchantment.FIRE_ASPECT.getName() + ":1" }), 16), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.BOW), "§6Lucky Bow"), new String[] { Enchantment.ARROW_FIRE.getName() + ":1", Enchantment.ARROW_DAMAGE.getName() + ":3" }), 16), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.BOW), "§6Lucky Bow"), new String[] { Enchantment.ARROW_KNOCKBACK.getName() + ":1", Enchantment.ARROW_DAMAGE.getName() + ":3" }), 16), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.BOW), "§6Lucky Bow"), new String[] { Enchantment.ARROW_INFINITE.getName() + ":1", Enchantment.ARROW_DAMAGE.getName() + ":2" }), 16),

					new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_HELMET), "§6Lucky Helm"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 25), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_CHESTPLATE), "§6Lucky Chestplate"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":3", Enchantment.THORNS.getName() + ":1" }), 12), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_LEGGINGS), "§6Lucky Leggings"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 20), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_BOOTS), "§6Lucky Boots"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.PROTECTION_FALL.getName() + ":4" }), 15),

					new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_HELMET), "§6Lucky Helm"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":1", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 35), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_CHESTPLATE), "§6Lucky Chestplate"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.THORNS.getName() + ":1" }), 15), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_LEGGINGS), "§6Lucky Leggings"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":1", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 25), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.DIAMOND_BOOTS), "§6Lucky Boots"), new String[] { Enchantment.PROTECTION_FALL.getName() + ":4" }), 20),

					new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_HELMET), "§6Lucky Helm"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 35), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_CHESTPLATE), "§6Lucky Chestplate"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":3", Enchantment.THORNS.getName() + ":1" }), 15), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_LEGGINGS), "§6Lucky Leggings"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 30), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_BOOTS), "§6Lucky Boots"), new String[] { Enchantment.PROTECTION_FALL.getName() + ":4" }), 25),

					new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_HELMET), "§6Lucky Helm"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":1", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 40), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_CHESTPLATE), "§6Lucky Chestplate"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":2", Enchantment.THORNS.getName() + ":1" }), 16), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_LEGGINGS), "§6Lucky Leggings"), new String[] { Enchantment.PROTECTION_ENVIRONMENTAL.getName() + ":1", Enchantment.PROTECTION_FIRE.getName() + ":1", Enchantment.PROTECTION_EXPLOSIONS.getName() + ":1" }), 30), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_BOOTS), "§6Lucky Boots"), new String[] { Enchantment.PROTECTION_FALL.getName() + ":4" }), 25),

					new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_SPADE), "§6Lucky Shovel"), new String[] { Enchantment.DIG_SPEED.getName() + ":2" }), 35), new LuckyItem(UtilItem.EnchantItem(UtilItem.RenameItem(new ItemStack(Material.GOLD_SPADE), "§6Lucky Shovel"), new String[] { Enchantment.DIG_SPEED.getName() + ":1" }), 30), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.MILK_BUCKET), "§6Milk Bucket"), 45), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.ARROW), "§6Arrow"), 10, 25, 65), new LuckyItem(new ItemStack[] { UtilItem.RenameItem(new ItemStack(Material.CAKE, 2), "§6Lucky Food"), UtilItem.RenameItem(new ItemStack(Material.COOKIE, 8), "§6Lucky Food") }, 60), new LuckyItem(new ItemStack[] { UtilItem.RenameItem(new ItemStack(Material.LAVA_BUCKET, 1), "§6Lucky Lava"), UtilItem.RenameItem(new ItemStack(Material.WATER_BUCKET, 1), "§6Lucky Water") }, 40), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.FISHING_ROD), "§6Lucky Fishing Rod"), 40), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.EXP_BOTTLE, 16), "§6Lucky XP"), 30), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.ENDER_PEARL, 1), "§6Lucky Pearl"), 35), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.ENDER_PEARL, 3), "§6Lucky Pearl"), 5), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.BRICK, 64), "§6Lucky Brick"), 40), new LuckyItem(new ItemStack[] { UtilItem.RenameItem(new ItemStack(Material.TNT, 3), "§6Lucky TNT"), UtilItem.RenameItem(new ItemStack(Material.FIREBALL, 2), "§6Lucky Fireball") }, 40), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.SNOW_BALL), "§6Lucky Snowball"), 5, 15, 50), new LuckyItem(UtilItem.RenameItem(new ItemStack(Material.EGG), "§6Lucky Egg"), 5, 15, 50), new LuckyPotion(PotionType.POISON, true, 8, 1, 1, 2, 50), new LuckyPotion(PotionType.SPEED, true, 45, 1, 1, 2, 40), new LuckyPotion(PotionType.STRENGTH, true, 20, 1, 1, 2, 40), new LuckyPotion(PotionType.REGEN, true, 30, 1, 1, 2, 40), new LuckyItem(new ItemStack(373, 1, (short) 16421), 2, 4, 55), }));
		...
		if (skyWarsType == SkyWarsType._32x4) {
			...
			for (Team t : skyWarsType.getTeam()) {
				if (getWorldData().existLoc(t)) {
					color = UtilMath.randomInteger(15);
	...
	public ItemStack Sonstiges() {
		try {
			switch (UtilMath.randomInteger(43)) {
			case 0:
				return new ItemStack(Material.ENDER_PEARL, UtilMath.RandomInt(4, 2));
			case 1:
				return new ItemStack(Material.GOLDEN_APPLE, 1);
			case 2:
				return new ItemStack(Material.ARROW, UtilMath.RandomInt(64, 32));
			case 3:
				return new ItemStack(Material.ARROW, UtilMath.RandomInt(64, 32));
			case 4:
				return new ItemStack(Material.ARROW, UtilMath.RandomInt(64, 32));
			...
			case 11:
				return new ItemStack(Material.TNT);
			case 12:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16421);
			case 13:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16417);
			case 14:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16389);
			case 15:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16385);
			case 16:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16387);
			case 17:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16421);
			case 18:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16417);
			...
			case 21:
				return new ItemStack(Material.POTION, UtilMath.RandomInt(3, 1), (short) 16387);
			case 22:
				return new ItemStack(Material.SNOW_BALL, UtilMath.RandomInt(16, 10));
			case 24:
				return new ItemStack(Material.SNOW_BALL, UtilMath.RandomInt(16, 10));
			case 25:
				return new ItemStack(Material.SNOW_BALL, UtilMath.RandomInt(16, 10));
			...
			case 27:
				return new ItemStack(Material.SNOW_BALL, UtilMath.RandomInt(16, 10));
			case 28:
				return new ItemStack(Material.EGG, UtilMath.RandomInt(16, 10));
			case 29:
				return new ItemStack(Material.EGG, UtilMath.RandomInt(16, 10));
			case 30:
				return new ItemStack(Material.EGG, UtilMath.RandomInt(16, 10));
			case 31:
				return new ItemStack(Material.EGG, UtilMath.RandomInt(16, 10));
			case 32:
				return new ItemStack(Material.COOKED_BEEF, UtilMath.RandomInt(12, 8));
			case 33:
				return new ItemStack(Material.COOKED_CHICKEN, UtilMath.RandomInt(12, 8));
			case 34:
				return new ItemStack(Material.COOKED_FISH, UtilMath.RandomInt(12, 8));
			case 35:
				return new ItemStack(Material.COOKED_RABBIT, UtilMath.RandomInt(12, 8));
			case 36:
		...
		if (ev.getEntity() instanceof Player) {
			if (ev.getDamager() instanceof Player) {
				if (this.hit.containsKey(((Player) ev.getEntity()))) {
					if (this.hit.get(((Player) ev.getEntity())).getUniqueId() == ((Player) ev.getDamager()).getUniqueId())
						return;
				...
				if (this.hit.containsKey(((Player) ev.getEntity()))) {
					if (this.hit.get(((Player) ev.getEntity())).getUniqueId() == ((Player) ((Projectile) ev.getDamager()).getShooter()).getUniqueId())
						return;
					this.hit.remove(((Player) ev.getEntity()));
				}
	...
	public Team getChestSpawn(Team team) {
		if (skyWarsType == SkyWarsType._32x4) {
			...
			case WHITE:
				return Team.SHEEP_WHITE;
			case BLACK:
				return Team.SHEEP_BLACK;
			case CYAN:
				return Team.SHEEP_CYAN;
			case AQUA:
				return Team.SHEEP_AQUA;
			case BROWN:
				return Team.SHEEP_BROWN;
			case MAGENTA:
				return Team.SHEEP_MAGENTA;
			case LIGHT_GRAY:
				return Team.SHEEP_LIGHT_GRAY;
			case LIME:
				return Team.SHEEP_LIME;
			default:
				return Team.SHEEP_RED;
			}
		}
	...
	public ItemStack rdmFood() {
		switch (UtilMath.randomInteger(4)) {
		case 0:
			return new ItemStack(Material.COOKED_BEEF, UtilMath.RandomInt(16, 8));
		case 1:
			return new ItemStack(Material.BREAD, UtilMath.RandomInt(16, 8));
		case 2:
			return new ItemStack(Material.CAKE);
		case 3:
			return new ItemStack(Material.CARROT, UtilMath.RandomInt(16, 8));
		default:
			return new ItemStack(Material.GOLDEN_CARROT, UtilMath.RandomInt(16, 8));
		}
	}
	...
	public void fillIslandChests(Team t, Chest[] chests) {
		// SWORD BLOCK HELM CHESTPLATE LEGGINGS BOOTS BOW ARROW POTION FOOD
		// SNOWBALL EGG WEB LAVA-BUCKET WATER-BUCKET
		template.clear();
		template_type.clear();
		...
		if (UtilMath.randomInteger(100) > 99) {
			add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "BOW");
			add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "ARROW");
		} else {
		...
		if (skyWarsType == SkyWarsType._32x4) {
			add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "FOOD");
			add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "FOOD");
		}

		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "SWORD");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "BLOCK");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "BLOCK");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "BLOCK");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "TOOL");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "POTION");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "CHESTPLATE");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "BOOTS");
		add((Chest) template.keySet().toArray()[UtilMath.randomInteger(template.size())], "FOOD");
		...
		for (Chest chest : template.keySet()) {
			...
			for (int i = 0; i < (r - list.size()); i++) {
				add(chest, (String) this.template_type.keySet().toArray()[UtilMath.randomInteger(this.template_type.size())]);
			}
		}
	...
	public void inGame(UpdateEvent ev) {
		...
		for (Player p : UtilServer.getPlayers())
			UtilDisplay.displayTextBar(TranslationHandler.getText(p, "GAME_END_IN", format), p);
		updateTime(format);
		switch (getStart()) {
		case 10 * 60:
			Chest chest;
	...
	public void DeathSkyWars(PlayerDeathEvent ev) {
		if (ev.getEntity() instanceof Player) {
			...
			if (ev.getEntity().getKiller() instanceof Player || this.hit.containsKey(((Player) ev.getEntity()))) {
				...
				this.hit.remove(a);
				Title t = new Title("§c§lYOUR ARE DEAD!", "§a" + a.getName() + ": " + UtilPlayer.getPlayerLiveString(a));
				t.send(v);
				return;
			}
	...
	public void statsLOADED(PlayerStatsLoadedEvent ev) {
		...
		if (UtilPlayer.isOnline(ev.getPlayerId())) {
			...
			Bukkit.getScheduler().runTask(getManager().getInstance(), new Runnable() {
				...
				@Override
				public void run() {
					getManager().getHologram().sendText(player, getManager().getLoc_stats(), new String[] { Color.GREEN + getType().getTyp() + " " + skyWarsType.name().replaceAll("_", "") + Color.ORANGE + "§l Info", TranslationHandler.getText(player, "GAME_HOLOGRAM_SERVER", getType().getTyp() + " §a" + kArcade.id), TranslationHandler.getText(player, "GAME_HOLOGRAM_MAP", (getWorldData().getMap() != null ? getWorldData().getMapName() : "Loading...")), " ", TranslationHandler.getText(player, "GAME_HOLOGRAM_STATS", getType().getTyp()), TranslationHandler.getText(player, "GAME_HOLOGRAM_KILLS", getStats().getInt(StatsKey.KILLS, player)), TranslationHandler.getText(player, "GAME_HOLOGRAM_DEATHS", getStats().getInt(StatsKey.DEATHS, player)), " ", TranslationHandler.getText(player, "GAME_HOLOGRAM_GAMES", (((Integer) w) + ((Integer) l))), TranslationHandler.getText(player, "GAME_HOLOGRAM_WINS", ((Integer) w)), TranslationHandler.getText(player, "GAME_HOLOGRAM_LOSE", ((Integer) l)), });
				}
			});
		}
	}
	...
	public void GameStartSkyWars(GameStartEvent ev) {
		...
		for (Player p : UtilServer.getPlayers()) {
			...
			UtilScoreboard.setScore(ps, "§ewww.EpicPvP.eu", DisplaySlot.SIDEBAR, 0);
